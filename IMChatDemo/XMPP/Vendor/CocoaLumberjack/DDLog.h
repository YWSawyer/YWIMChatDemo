...
#define LOG_FLAG_SEND  (1 << 5)  // 0..100000
...
#define LOG_LEVEL_SEND (LOG_FLAG_ERROR | LOG_FLAG_WARN | LOG_FLAG_INFO | LOG_FLAG_DEBUG | LOG_FLAG_VERBOSE | LOG_FLAG_SEND)      // 0...11111
